  ...
  return (
    <nav className="bg-white border-b border-[#E5E7EB] sticky top-0 z-40 shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
      ...
      <div className="h-14 sm:h-16 px-3 sm:px-6 grid grid-cols-3 items-center">
        ...
        {/* Right: Admin + Logout for mobile only */}
        <div className="flex items-center justify-end gap-2 sm:gap-3 sm:hidden">
          {/* Admin pill */}
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[#FCA5A5] text-[#DC2626] text-[12px] font-medium hover:bg-[#FEF2F2] transition-all duration-200"
          >
            {/* Logout icon */}
